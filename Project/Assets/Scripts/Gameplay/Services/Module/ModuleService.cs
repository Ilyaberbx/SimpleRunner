...
namespace Factura.Gameplay.Services.Module
{
    ...
    public sealed class ModuleService : PocoService<ModuleServiceSettings>
    {
        ...
        private readonly IDictionary<Type, IModuleFactory> _typeFactoryMap = new Dictionary<Type, IModuleFactory>();
        ...
        public void RegisterFactory<TModule>(IModuleFactory factory) where TModule : VehicleModuleBehaviour
        {
